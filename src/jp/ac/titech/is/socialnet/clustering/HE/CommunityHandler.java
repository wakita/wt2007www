package jp.ac.titech.is.socialnet.clustering.HE;
	...
	private Community merge(Community i, Community j){
		...
		while(main_neighbor != null && absorbed_neighbor != null){
			...
			if(relation == 0){
				...
				double deltaQR = CommunityPair.calcDeltaQR(delta, main_dest.size, i.size+ j.size);
				...
				double deltaQR = CommunityPair.calcDeltaQR(delta, absorbed_dest.size, i.size+ j.size);
