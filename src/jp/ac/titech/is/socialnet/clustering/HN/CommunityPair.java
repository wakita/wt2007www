...
public class CommunityPair implements Comparable<CommunityPair>{
   ...
   /* public static double calcRatio(int size_i, int size_j){
    ...
    public static double calcRatio(int node_num_i, int node_num_j){
    	//return Math.min(((double)size_i)/((double)size_j), ((double)size_j)/((double)size_i));
    	
    	return Math.min(((double)node_num_i)/((double)node_num_j), ((double)node_num_j)/((double)node_num_i));
    }
    ...
    public static double calcDeltaQR(long deltaQ, int node_num_i, int node_num_j){
    	return calcDeltaQR(deltaQ, calcRatio(node_num_i, node_num_j));
    }
    ...
    private double calcRatio(){
    	...
    	return Math.min(((double)i.node_num)/((double)j.node_num), ((double)j.node_num)/((double)i.node_num));
    }
