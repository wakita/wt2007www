...
/*		while(current_pair != null){
	...
	public void assertConsistency(){
		CommunityPair currentPair = first;
		Community currentCom;
		int currentID = -1;
		while(currentPair != null){
			currentCom = currentPair.destCommunity(this);
			assert currentID < currentCom.id;
			System.out.print(currentID + ",");
			currentID = currentCom.id;
			currentPair = currentPair.next(this);
		}
		System.out.println();
	}

	public void assertNeighborConsistency(){
		CommunityPair currentPair = first;
		Community currentCom;
		while(currentPair != null){
			currentCom = currentPair.destCommunity(this);
			currentCom.assertConsistency();
			currentPair = currentPair.next(this);
		}
	}
